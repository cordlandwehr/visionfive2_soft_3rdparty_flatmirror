...
#if defined(HAL_GPIO_ENABLED) && defined(HAL_GPIO_SFT_VIC1_GPIO)

#include "hal_gpio_sft_vic1_gpio.h"
...
#endif /* HAL_GPIO_ENABLED && HAL_GPIO_SFT_VIC1_GPIO */

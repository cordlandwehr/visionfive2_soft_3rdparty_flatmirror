...
clock_freq_t sys_clock_freq(sys_clock_t clk)
{
    ...
    switch (clk) {
        ...
        case CLK_PWM_8CH_APB:       return FPGA_CLK_APB / 6;
        ...
        case CLK_SSP0_CORE: return FPGA_CLK_APB / 2;
        case CLK_SSP1_CORE: return FPGA_CLK_APB / 2;
        case CLK_SSP2_CORE: return FPGA_CLK_APB / 2;
        case CLK_SSP3_CORE: return FPGA_CLK_APB / 2;
        case CLK_SSP4_CORE: return FPGA_CLK_APB / 2;
        case CLK_SSP5_CORE: return FPGA_CLK_APB / 2;
        case CLK_SSP6_CORE: return FPGA_CLK_APB / 2;
